...
energy_Dihedral_Dunbrack <- readRDS('Data/Dunbrack/energy_torsion_Dunbrack1.rds')
...
write.csv(E20_torsion.dun,'Data/Dunbrack/E20_torsion.dun.csv',row.names = F)
write.csv(freqAA20.dun,'Data/Dunbrack/freqAA20.dun.csv',row.names = F)

freqAA20.dun <- read.csv('Data/Dunbrack/freqAA20.dun.csv')
E20_torsion.dun <- read.csv('Data/Dunbrack/E20_torsion.dun.csv')

Pi <- read.csv('Data/Dunbrack/Pi_torsion.csv',header = F)
...
# ---------------------
saveRDS(E20_seq_torsion_astral,'Data/rds/E20_seq_torsion_astral.rds')
saveRDS(E20_torsion_astral,'Data/rds/E20_torsion_astral.rds')
```
...
dis <- data.frame(pdb_mut_chain=df$pdb_mut_chain, matrix(NA,nrow(df),252))
...
saveRDS(df,paste0('~/Desktop/df', infile, 'N.rds'))
```
...
# ---------------------------------
rf <- tuneRF(df[df$pH==7&df$TEMP==25,-c(1:9)], df$ddG, doBest = T,plot = F,
