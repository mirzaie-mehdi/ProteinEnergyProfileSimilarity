...
scID <- unique(astral$scopeID)
m <- match(sc1000$V1, scID)
# -------------------------------------
...
cath40 <- cath[cath$V1%in%ns40,]
ff <- data.frame(table(cath40$superfamily))
sf <- ff[ff$Freq>10,1]
dID <- cath40$V1[cath40$superfamily%in%sf]
