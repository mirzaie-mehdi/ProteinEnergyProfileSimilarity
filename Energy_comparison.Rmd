...
folda1 = protein_data[protein_data$fold1 %in% "a.2"& protein_data$fold2 %in% "a.2",]
plot(folda1$LengthDifference,folda1$Distance)

different_proteins <- protein_data[protein_data$fold1 != protein_data$fold2 
...
#mulidup_tm <- read.delim('Data/dup/dup_tm.csv')
mulidup_tm <- read.csv("Data/dup/dup_tm.csv", header=T)

dis_old <- rep(0, nrow(mulidup))
dis_old_diff = dis_old
dis_new_min = dis_old
dis_new <- rep(0, nrow(mulidup))
len <- data.frame(len1=rep(0,nrow(mulidup)),
                  len2=rep(0,nrow(mulidup)))
...
mulidup_tm <- data.frame(mulidup_tm,dis_old,dis_new,dis_old_diff,dis_new_min)
