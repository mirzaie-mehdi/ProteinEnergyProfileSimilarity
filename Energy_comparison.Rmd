...
df_family_str <- data.frame(data='Astral 40-superfamily a.29.3',type='SEP',
...
df_family_seq <- data.frame(data='Astral 40-superfamily a.29.3',type='CEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# **********
...
df_family_str <- data.frame(data='Astral 95-superfamily a.29.3',type='SEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# ****** sequence95
...
df_family_seq <- data.frame(data='Astral 95-superfamily a.29.3',type='CEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# **********
...
df_superfamily_str <- data.frame(data='Astral 40-fold a.29',type='SEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# ****** sequence40
...
df_superfamily_seq <- data.frame(data='Astral 40-fold a.29',type='CEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# **********
...
df_superfamily_str <- data.frame(data='Astral 95-fold a.29',type='SEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# ****** sequence95
...
df_superfamily_seq <- data.frame(data='Astral 95-fold a.29',type='CEP',
                            gr=rep(c('within','between'),
                                   c(length(within),length(between))),
                            distance=c(within,between)) 
# **********
...
df_fold_str <- data.frame(data='Astral 40-class alpha',type='SEP',
...
wit <- within[sample(length(within),1000)] 
bet <- between[sample(length(between),1000)] 
df_fold_seq <- data.frame(data='Astral 40-class alpha',type='CEP',
                            gr=rep(c('within','between'),c(1000,1000)),
                            distance=c(wit,bet))
# **********
...
wit <- within[sample(length(within),1000)] 
bet <- between[sample(length(between),1000)] 
df_fold_str <- data.frame(data='Astral 95-class alpha',type='SEP',
                            gr=rep(c('within','between'),c(1000,1000)),
                            distance=c(wit,bet))
# ****** sequence95
df <- readRDS("Data/rds/E210.seq_astral_95.rds") 
...
wit <- within[sample(length(within),1000)] 
bet <- between[sample(length(between),1000)] 
df_fold_seq <- data.frame(data='Astral 95-class alpha',type='CEP',
                            gr=rep(c('within','between'),c(1000,1000)),
                            distance=c(wit,bet)) 
# **********
df_fold <- rbind(df_fold_seq, df_fold_str)
...
load('Data/rds/UMPs.RData')
ump_df_str40$type <- ifelse(ump_df_str40$type=='Structure','SEP','CEP')
ump_df_seq40$type <- ifelse(ump_df_seq40$type=='Structure','SEP','CEP')
ump_df_str95$type <- ifelse(ump_df_str95$type=='Structure','SEP','CEP')
ump_df_seq95$type <- ifelse(ump_df_seq95$type=='Structure','SEP','CEP')
...
ump <- umap(d = dis,
            ...
            min_dist = 0.1,
            input="dist")
ump_df_str <- data.frame(data='Astral 40',type='SEP',
                           class=df[,1],
                           UMAP1 = ump$layout[, 1],
                           UMAP2 = ump$layout[, 2])
...
ump <- umap(d = dis,
            ...
            min_dist = 0.1,
            input="dist")
ump_df_seq <- data.frame(data='Astral 40',type='CEP',
                           class=df[,1],
                           UMAP1 = ump$layout[, 1],
                           UMAP2 = ump$layout[, 2])
...
ump <- umap(d = dis,
            ...
            min_dist = 0.1,
            input="dist")
ump_df_str <- data.frame(data='Astral 95',type='SEP',
                           class=df[,1],
                           UMAP1 = ump$layout[, 1],
                           UMAP2 = ump$layout[, 2])
...
ump <- umap(d = dis,
            ...
            min_dist = 0.1,
            input="dist")
ump_df_seq <- data.frame(data='Astral 95',type='CEP',
                           class=df[,1],
                           UMAP1 = ump$layout[, 1],
                           UMAP2 = ump$layout[, 2])
z <- rbind(ump_df_str,ump_df_seq)
