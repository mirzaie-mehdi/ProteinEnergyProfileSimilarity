...
#path = '/home/peymanc/Desktop/'
# ----------------------------------------------
df = pd.read_csv(path+'/HumanRAS/annot_HumanRAS.csv')
# ----------------------------------------------
start = time.time()
n=df.shape[0]
...
#emb.to_csv(path+'/HumanRAS/TM_vec_emb_HumanRAS.csv',index=False)
...
cosine_similarity_df.to_csv(path+'/HumanRAS/disTM_vec_HumanRAS.csv',index=False)
