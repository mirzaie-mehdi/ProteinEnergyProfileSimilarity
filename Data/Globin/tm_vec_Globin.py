...
# ----------------------------------------------
df = pd.read_csv(path+'/Globin/Globin.csv')
# ----------------------------------------------
start = time.time()
n=df.shape[0]
...
emb.to_csv(path+'TM_vec_emb_Globin.csv',index=False)
...
cosine_similarity_df.to_csv(path+'/Globin/disTM_vec_Globin.csv',index=False)
