...
path = '/home/peymanc/Desktop/new_data/SARS2_FrustraEvo_input_and_output/'
# ----------------------------------------------
df = pd.read_csv(path+'sars_proteom.csv')
# ----------------------------------------------
start = time.time()
n=df.shape[0]
...
#emb.to_csv(path+'TM_vec_emb_GT.csv',index=False)
...
cosine_similarity_df.to_csv(path+'disTM_vec_sars_proteom.csv',index=False)
