...
df_tot <- readRDS('Fig_Manuscript/Revised/fig_data/df_total_energy.rds')
...
B <- ggplot(df_tot[df_tot$data=='ASTRAL95',], aes(seq/2000,str/1000))+
  ...
  theme(strip.text.x = element_text(size = 20))
# ************** distance 40 and 95
df_dis40<-readRDS('Fig_Manuscript/Revised/fig_data/dis_40_manhat.rds')
df_dis95<-readRDS('Fig_Manuscript/Revised/fig_data/dis_95_manhat.rds')
...
source('Functions.R')
# ----------------------------------------------------
load('Fig_Manuscript/Revised/fig_data/UMPs.RData')
...
saveRDS(A,'Fig_Manuscript/Revised/fig_data/Fig5A.rds')
```
...
B <- ggarrange(NULL,NULL,NULL,NULL,
  ...
  font.label = list(size = 30),
  hjust = .2,vjust = 0)
saveRDS(B,'Fig_Manuscript/Revised/fig_data/Fig5B.rds')
```
...
C <- ggarrange(NULL,NULL,NULL,NULL,
  ...
  font.label = list(size = 30),
  hjust = .2,vjust = 0)
saveRDS(C,'Fig_Manuscript/Revised/fig_data/Fig5C.rds')
```
...
```{r Fig 5 ABC}
rm(list = ls())
A <- readRDS('Fig_Manuscript/Revised/fig_data/Fig5A.rds')
B <- readRDS('Fig_Manuscript/Revised/fig_data/Fig5B.rds')
C <- readRDS('Fig_Manuscript/Revised/fig_data/Fig5C.rds')
# ------------------------
...
saveRDS(mylegend,'Fig_Manuscript/Revised/fig_data/Fig6mylegend.rds')
# ******************************************
# ****** structure95
df <- readRDS("Data/rds/E210.astral_95.rds") 
df = df[!is.na(df$FL),] 
...
saveRDS(EF,'Fig_Manuscript/Revised/fig_data/Fig6EF.rds')
```
...
saveRDS(CD,'Fig_Manuscript/Revised/fig_data/Fig6CD.rds')
```
...
saveRDS(AB,'Fig_Manuscript/Revised/fig_data/Fig6AB.rds')
```
...
```{r Fig 6 All}
rm(list = ls())
EF <- readRDS('Fig_Manuscript/Revised/fig_data/Fig6EF.rds')
CD <- readRDS('Fig_Manuscript/Revised/fig_data/Fig6CD.rds')
AB <- readRDS('Fig_Manuscript/Revised/fig_data/Fig6AB.rds')
mylegend <-readRDS('Fig_Manuscript/Revised/fig_data/Fig6mylegend.rds')
# ---------------------------------------------
...
## Fig 9C,E,G ferritin (mean distance)

```{r Fig 9C,E,G ferritin (mean distance)}
source('Functions.R')
# -----------------------
...
## Fig 10i (Spike Inter-Similarity)
...
for (i in 1:6) {
  ...
  ggsave(filename = paste0('Fig_Manuscript/Revised/sup_Fig/210Cor', i, '.png'), 
