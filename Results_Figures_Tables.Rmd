...
df_tot <- readRDS('Figures_Paper/fig_data/df_total_energy.rds')
...
MYwriteData(data=df_tot[,-c(2:5)],
            file="Figures_Paper/SourceData.xlsx", 
            sheet="Figure 2 A-B",
            row.Names = TRUE)
# ************** distance 40 and 95
df_dis40<-readRDS('Figures_Paper/fig_data/dis_40_manhat.rds')
df_dis95<-readRDS('Figures_Paper/fig_data/dis_95_manhat.rds')
...
A<-ggarrange(NULL,NULL,NULL,NULL,
  ...
  hjust = .2,vjust = 0)
#saveRDS(A,'Figures_Paper/Old_Figures/Fig4A.rds')
saveRDS(A,'Figures_Paper/fig_data/Fig3A.rds')
# ----------SourceData---------------
ump <- rbind(z40,z95)
...
B <- ggarrange(NULL,NULL,NULL,NULL,
  ...
  font.label = list(size = 30),
  hjust = .2,vjust = 0)
saveRDS(B,'Figures_Paper/fig_data/Fig3B.rds')
# ----------SourceData---------------
ump <- rbind(z40,z95)
MYwriteData(data=ump,
            file="Figures_Paper/SourceData.xlsx", 
...
C <- ggarrange(NULL,NULL,NULL,NULL,
  ...
  font.label = list(size = 30),
  hjust = .2,vjust = 0)
saveRDS(C,'Figures_Paper/fig_data/Fig3C.rds')
# ----------SourceData---------------
ump <- rbind(z40,z95)
MYwriteData(data=ump,
            file="Figures_Paper/SourceData.xlsx", 
...
```{r Fig 3 ABC}
rm(list = ls())
A <- readRDS('Figures_Paper/fig_data/Fig3A.rds')
B <- readRDS('Figures_Paper/fig_data/Fig3B.rds')
C <- readRDS('Figures_Paper/fig_data/Fig3C.rds')
# ------------------------
...
#     ggsave(filename = paste0('Figures_Paper/Revised/supp_Fig/210Cor', #   i, '.png'), 
...
source('Functions/Functions.R')
# ----------------------------------------------------
load('Figures_Paper/fig_data/UMPs.RData')
...
mylegend <- get_legend(E+
                           theme(legend.position = 'bottom',
                                 legend.title = element_blank(),
                                 legend.text = element_text(size = 20)))
saveRDS(mylegend,'Figures_Paper/fig_data/FigS4mylegend.rds')
# ******************************************
# ****** structure95
df <- readRDS("Data/rds/E210.astral_95.rds") 
df = df[!is.na(df$FL),] 
...
#saveRDS(EF,'Figures_Paper/fig_data/FigS4EF.rds')
```
...
#saveRDS(CD,'Figures_Paper/fig_data/FigS4CD.rds')
```
...
saveRDS(AB,'Figures_Paper/fig_data/FigS4AB.rds')
```
...
```{r Fig S4 All}
rm(list = ls())
EF <- readRDS('Figures_Paper/fig_data/FigS4EF.rds')
CD <- readRDS('Figures_Paper/fig_data/FigS4CD.rds')
AB <- readRDS('Figures_Paper/fig_data/FigS4AB.rds')
mylegend <-readRDS('Figures_Paper/fig_data/FigS4mylegend.rds')
# ---------------------------------------------
