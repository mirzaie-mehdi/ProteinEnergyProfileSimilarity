...
saveRDS(A,'manuscript/Revised/fig_data/Fig5A.rds')
```
...
B <- ggarrange(NULL,NULL,NULL,NULL,
  ...
  font.label = list(size = 30),
  hjust = .2,vjust = 0)
saveRDS(B,'manuscript/Revised/fig_data/Fig5B.rds')
```
...
C <- ggarrange(NULL,NULL,NULL,NULL,
  ...
  font.label = list(size = 30),
  hjust = .2,vjust = 0)
saveRDS(C,'manuscript/Revised/fig_data/Fig5C.rds')
```
...
```{r Fig 4 ABC}
rm(list = ls())
A <- readRDS('manuscript/Revised/fig_data/Fig5A.rds')
B <- readRDS('manuscript/Revised/fig_data/Fig5B.rds')
C <- readRDS('manuscript/Revised/fig_data/Fig5C.rds')
# ------------------------
...
saveRDS(mylegend,'manuscript/Revised/fig_data/Fig6mylegend.rds')
# ******************************************
# ****** structure95
df <- readRDS("Data/rds/E210.astral_95.rds") 
df = df[!is.na(df$FL),] 
...
saveRDS(EF,'manuscript/Revised/fig_data/Fig6EF.rds')
```
...
saveRDS(CD,'manuscript/Revised/fig_data/Fig6CD.rds')
```
...
saveRDS(AB,'manuscript/Revised/fig_data/Fig6AB.rds')
```
...
```{r Fig 5 All}
rm(list = ls())
EF <- readRDS('manuscript/Revised/fig_data/Fig6EF.rds')
CD <- readRDS('manuscript/Revised/fig_data/Fig6CD.rds')
AB <- readRDS('manuscript/Revised/fig_data/Fig6AB.rds')
mylegend <-readRDS('manuscript/fig_data/Fig6mylegend.rds')
# ---------------------------------------------
