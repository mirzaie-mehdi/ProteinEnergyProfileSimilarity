...
path2 = '~/Desktop/proj/Dunbrack/PDBs/';
path='../Train_Energy/';
load([path 'energy_dell_dunbrack_rm_Olaps.mat']);
...
Nfile=1;
fid2=fopen([path '/list_with_chainID_rm_Olaps.txt']);
...
toc
save([path '/zi_rm_Olaps.mat'], 'zi')
save([path '/esk_rm_Olaps.mat'], 'esk')
zzi=cell(1,20);
for i=1:20
    for j=2:size(zi,1)
...
save([path '/zzi_rm_Olaps.mat'],'zzi')