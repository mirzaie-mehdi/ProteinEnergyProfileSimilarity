...
```{r}
cpe <- E210.seq_ferritin
spe <- readRDS("Data/rds/E210_ferritin.rds")

rownames(spe) <- spe$pdbID
dis_spe <- proxy::dist(spe[,-c(1:3)]/spe$length, method = manhat)
dis_cpe <- proxy::dist(cpe[,-c(1:4)], method = manhat)

plot(dis_cpe, dis_spe)
```
