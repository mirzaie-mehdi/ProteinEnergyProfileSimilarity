...
```{r}
E210.seq_spike200 <- readRDS("Data/rds/E210.seq_spike_close.rds")
#-----------close
...
adjustedRandIndex(cutree(hc, 4), df$virus)
...
# -----------------------
E210_spike200 <- readRDS("Data/rds/E210_spike_close.rds")
#-----------close
df = E210_spike200
df = df[!is.na(df$length),]
df = df[df$conformation == "Close",]
