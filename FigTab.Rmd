...
title_grob <- grobTree(
  textGrob("Evolution of Spike protein", x = 0.5, y = -1, just = "center", gp = gpar(col = "black", fontsize = 23, fontface = "bold")),
  textGrob("MERS_Cov",           x = 0.38, y = -5,   just = "center", gp = gpar(col = "blue",  fontsize = 20, fontface = "bold")),
  textGrob(expression('\u2192'), x = 0.44, y = -5.5, just = "center", gp = gpar(col = "black", fontsize = 30, fontface = "bold")),
  textGrob("SARS_Cov",           x = 0.50, y = -5,   just = "center", gp = gpar(col = "green", fontsize = 20, fontface = "bold")),
  textGrob(expression('\u2192'), x = 0.56, y = -5.5, just = "center", gp = gpar(col = "black", fontsize = 30, fontface = "bold")),
  textGrob("SARS_Cov2",          x = 0.62, y = -5,   just = "center", gp = gpar(col = "red"  , fontsize = 20, fontface = "bold"))
)
