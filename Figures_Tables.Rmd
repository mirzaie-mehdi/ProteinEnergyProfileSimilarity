...
p190m <- p12h+xlim(c('CPE','TM-Vec','SPE'))+ylim(0,.44)+ #4.4*12*3.6 = 190sec
    theme(legend.text = element_text(face = 'bold',size = 15))
...
res_final <- data.frame(method=c('1NN','RF'),res_final)
# ----------------------------------------------------------------
# ----------------------------------------
# ---------- TM-Vec ----------------
# -------------------------------------------------------
...
# ---------- 1NN ----------------
# ---------------------------------------
dis <- read.csv('Data/csv/disTM_vec_fiveSF.csv') "Since this file exceeds 900 MB, you should first run the script `tm_vec_fiveSF.py`."
diag(dis) <- NA
