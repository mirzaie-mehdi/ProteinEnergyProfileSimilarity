...
rm(dis_seq, dis_str)
saveRDS(df_dis95,'Fig_Manuscript/Revised/fig_data/dis_95_manhat.rds')
# ************************************************************
# astral 40
df_seq <- readRDS("Data/rds/E210.seq_astral_40.rds") 
df_seq = df_seq[!is.na(df_seq$FL),] 
...
df_dis40 <- data.frame(data='Astral 40',
                       ...
                       dis_seq=as.vector(dis_seq)[idx])
rm(dis_seq, dis_str)
#saveRDS(df_dis40,'Fig_Manuscript/Old_Figures/dis_40_manhat.rds')
saveRDS(df_dis40,'Fig_Manuscript/Revised/fig_data/dis_40_manhat.rds')
# **************************************
df_tot <- rbind(df_tot40, df_tot95)
#saveRDS(df_tot, 'Fig_Manuscript/Old_Figures/df_total_energy.rds')
saveRDS(df_tot, 'Fig_Manuscript/Revised/fig_data/df_total_energy.rds')
```
...
#     file = 'Fig_Manuscript/Old_Figures/UMPs.RData')
save(ump_df_seq40,ump_df_seq95,ump_df_str40,ump_df_str95,
     file = 'Fig_Manuscript/Revised/fig_data/UMPs.RData')
```
